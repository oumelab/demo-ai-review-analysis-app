      ...
      <CardContent>
        <Tabs defaultValue="summary" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 gap-2">
            <TabsTrigger value="summary"><Pen />要約</TabsTrigger>
            <TabsTrigger value="positive"><ThumbsUp />評価ポイント</TabsTrigger>
            <TabsTrigger value="negative"><ThumbsDown />改善点</TabsTrigger>
            </TabsList>
            <TabsContent
            value="summary"
